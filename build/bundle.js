var app = (function () {
    ...
    /* src\ProgressBar.svelte generated by Svelte v3.30.1 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-157id5b");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-157id5b");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src\Timer.svelte generated by Svelte v3.30.1 */
    ...
    function instance$1($$self, $$props, $$invalidate) {
    		...
    		const timer = setInterval(
    			() => {
    				...
    				if (secondsLeft <= 0) {
    					...
    					$$invalidate(0, secondsLeft = length);
    					dispatch("end");
    				}
    			},
    			1000
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft, length*/ 17) {
    			 $$invalidate(2, progress = secondsLeft / length * 100);
    		}
    	};

    	return [secondsLeft, isRunning, progress, startTimer, length];
    }

    class Timer extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { length: 4 });
    	}
    }

    /* src\HowTo.svelte generated by Svelte v3.30.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="washing_guide.png" alt="Guide on how to wash your hands" class="svelte-1og64i1"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	let current;
    	timer = new Timer({ props: { length: "20" } });
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/">Picture source</a> 
	<a href="https://freesound.org/people/nckn/sounds/256113/">Sound source</a>`;

    			t7 = space();
    			audio_1 = element("audio");
    			attr(h1, "class", "svelte-1iujep4");
    			attr(h3, "class", "svelte-1iujep4");
    			if (audio_1.src !== (audio_1_src_value = "done.wav")) attr(audio_1, "src", audio_1_src_value);
    		},
    		m(target, anchor) {
